...
const ScrollableTabView = createReactClass({
	...
	propTypes: {
		...
		refreshingProfileFeed: PropTypes.bool,
		refreshingProfileCollection: PropTypes.bool,
		onRefreshingProfileFeed: PropTypes.func,
		onRefreshingProfileCollection: PropTypes.func,
	},
	...
	render() {
		...
		if (this.props.collapsableBar) {
			return <ScrollView
			    refreshControl={
				  <RefreshControl
				  refreshing={this.state.currentPage === 0 ? this.props.refreshingProfileFeed : this.props.refreshingProfileCollection}
				  onRefresh={this.state.currentPage === 0 ? this.props.onRefreshProfileFeed : this.props.onRefreshProfileCollection}/>
			    }
